...
export namespace Prisma {
  ...
  */
  ...
  export type cloudOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "ip" | "message" | "filename" | "log_time" | "data", ExtArgs["result"]["cloud"]>
  ...
  interface cloudFieldRefs {
    ...
    readonly ip: FieldRef<"cloud", 'String'>
    readonly message: FieldRef<"cloud", 'String'>
    readonly filename: FieldRef<"cloud", 'String'>
    readonly log_time: FieldRef<"cloud", 'DateTime'>
    readonly data: FieldRef<"cloud", 'String'>
  }
  ...
  export type logOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "action" | "createdAt" | "message", ExtArgs["result"]["log"]>
  ...
  export const cloudOrderByRelevanceFieldEnum: {
    ip: 'ip',
    message: 'message',
    filename: 'filename',
    data: 'data'
  ...
  export type cloudOrderByRelevanceFieldEnum = (typeof cloudOrderByRelevanceFieldEnum)[keyof typeof cloudOrderByRelevanceFieldEnum]
  ...
  export type cloudWhereInput = {
    ...
    ip?: StringNullableFilter<"cloud"> | string | null
    message?: StringNullableFilter<"cloud"> | string | null
    filename?: StringNullableFilter<"cloud"> | string | null
    log_time?: DateTimeNullableFilter<"cloud"> | Date | string | null
    data?: StringNullableFilter<"cloud"> | string | null
  }
  ...
  export type cloudOrderByWithRelationInput = {
    ...
    _relevance?: cloudOrderByRelevanceInput
  }
  ...
  export type cloudScalarWhereWithAggregatesInput = {
    ...
    ip?: StringNullableWithAggregatesFilter<"cloud"> | string | null
    message?: StringNullableWithAggregatesFilter<"cloud"> | string | null
    filename?: StringNullableWithAggregatesFilter<"cloud"> | string | null
    log_time?: DateTimeNullableWithAggregatesFilter<"cloud"> | Date | string | null
    data?: StringNullableWithAggregatesFilter<"cloud"> | string | null
  }
  ...
  export type cloudOrderByRelevanceInput = {
    fields: cloudOrderByRelevanceFieldEnum | cloudOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
